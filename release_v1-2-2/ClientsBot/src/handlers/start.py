...
from ..core.config import EDUCATIONAL_IMAGE_PATH
...
async def start_handler(message: types.Message, session: AsyncSession):
    ...
    with open(EDUCATIONAL_IMAGE_PATH, "rb") as file:
        file_content = file.read()

    educational_image = BufferedInputFile(file_content, filename=EDUCATIONAL_IMAGE_PATH.name)
    ...
    try:
        ...
        await message.answer_photo(educational_image)
